            ...
            <table class="table table-bordered">
                ...
                <c:forEach var="product" items="${ListProduct}">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/product?action=edit&id=${product.id}" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                            <a href="#" onclick="showMess(${product.id})" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
