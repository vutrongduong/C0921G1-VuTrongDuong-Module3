        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <a href="/product?action=add"><button type="button" class="btn btn-info add-new"><i class="fa fa-plus"></i> Add New</button></a>
                    </div>
                </div>
            </div>
            <table class="table table-bordered">
                ...
                <c:forEach var="product" items="${ListProduct}">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/product?action=edit&id=${product.id}" class="edit" title="Edit"
