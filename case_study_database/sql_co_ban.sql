...
update khach_hang
set ma_loai_khach=1
where ma_loai_khach!=1 and ma_khach_hang in (select tmp.ma_khach_hang from(select kh.ma_khach_hang
from khach_hang kh 
...
set gia=gia*2
where ma_dich_vu_di_kem in (select tmp.ma_dich_vu_di_kem from (select dvdk.ma_dich_vu_di_kem 
